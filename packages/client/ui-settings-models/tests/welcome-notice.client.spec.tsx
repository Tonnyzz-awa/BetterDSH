...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      title: 'BetterDSH Preview Notice',
      body: "BetterDSH remains in testing for developers. Many areas still need improvement, and we welcome feedback from the developer community. BetterDSH's core plugins and foundational APIs will continue to evolve rapidly over the coming months.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, open, reusable, and composable infrastructure. We welcome BetterDSH developers everywhere to join the BetterDSH plugin ecosystem.",
